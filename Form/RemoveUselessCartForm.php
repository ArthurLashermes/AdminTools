    ...
    protected function buildForm()
    {
        $this->formBuilder
            ->add('start_date', TextareaType::class,
                [
                    'label' => $this->translator->trans('Remove older carts from this date', [],  AdminTools::DOMAIN_NAME),
                    'required' => true,
                    'constraints' => [
                        new NotBlank(),
                        new Callback(
            ...
            ->add('remove_all', CheckboxType::class,
                [
                    'label' => $this->translator->trans('Remove even not empty carts', [], AdminTools::DOMAIN_NAME)
                ]
            );
    }
